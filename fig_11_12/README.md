...
- `notebooks/April8ECLIPSE_fig11_fig12.ipynb`: cleaned notebook that generates both figures and saves outputs to `fig_11/fig_11_N5DUP2024.jpg` and `fig_12/fig_12_2024Res.jpg`.
...
4. Run all cells; regenerated figures will overwrite the JPGs in `fig_11/` and `fig_12/`.
